...
const EditProformaModal = ({ open, handleClose, id }) => {
  ...
  const fetchProformaData = async (proformaId) => {
    try {
      const response = await axios.get(
        `https://www.tallercentenos.somee.com/api/Proformas/${proformaId}`
      );
  ...
  const fetchStatuses = async () => {
    try {
      const response = await axios.get("https://www.tallercentenos.somee.com/api/Proformas/estados");
  ...
  const handleSave = async () => {
    ...
    try {
      const response = await axios.put(
        `https://www.tallercentenos.somee.com/api/Proformas/${id}`,
        payload
      );
